...
@Generated({ "Generator: com.vaadin.generator.ComponentGenerator#1.0-SNAPSHOT",
        "WebComponent: ButtonsBarElement#null", "Flow#1.0-SNAPSHOT" })
@Tag("starter-buttons-bar")
@HtmlImport("frontend://bower_components/starter-elements/starter-buttons-bar.html")
public class GeneratedStarterButtonsBar<R extends GeneratedStarterButtonsBar<R>>
     ...
     * the returned value may not be the same as in client side.
     * 
     * @return the {@code action1Text} property from the webcomponent
     */
     ...
     * the returned value may not be the same as in client side.
     * 
     * @return the {@code action2Text} property from the webcomponent
     */
     ...
     * the returned value may not be the same as in client side.
     * 
     * @return the {@code action3Text} property from the webcomponent
     */
     ...
     * the returned value may not be the same as in client side.
     * 
     * @return the {@code action1Disabled} property from the webcomponent
     */
     ...
     * the returned value may not be the same as in client side.
     * 
     * @return the {@code action2Disabled} property from the webcomponent
     */
     ...
     * the returned value may not be the same as in client side.
     * 
     * @return the {@code action3Disabled} property from the webcomponent
     */
    ...
    @DomEvent("action1")
    public static class Action1Event<R extends GeneratedStarterButtonsBar<R>>
            extends ComponentEvent<R> {
        public Action1Event(R source, boolean fromClient) {
            super(source, fromClient);
        }
    }

    /**
     * Adds a listener for {@code action1} events fired by the webcomponent.
     * 
     * @param listener
     *            the listener
    ...
    public Registration addAction1Listener(
            ComponentEventListener<Action1Event<R>> listener) {
        return addListener(Action1Event.class,
                (ComponentEventListener) listener);
    }

    @DomEvent("action2")
    public static class Action2Event<R extends GeneratedStarterButtonsBar<R>>
            extends ComponentEvent<R> {
        public Action2Event(R source, boolean fromClient) {
            super(source, fromClient);
        }
    }

    /**
     * Adds a listener for {@code action2} events fired by the webcomponent.
     * 
     * @param listener
     *            the listener
     * @return a {@link Registration} for removing the event listener
     */
    @SuppressWarnings({ "rawtypes", "unchecked" })
    public Registration addAction2Listener(
            ComponentEventListener<Action2Event<R>> listener) {
        return addListener(Action2Event.class,
                (ComponentEventListener) listener);
    }

    @DomEvent("action3")
    public static class Action3Event<R extends GeneratedStarterButtonsBar<R>>
            extends ComponentEvent<R> {
        public Action3Event(R source, boolean fromClient) {
            super(source, fromClient);
        }
    }

    /**
     * Adds a listener for {@code action3} events fired by the webcomponent.
     * 
     * @param listener
     *            the listener
     * @return a {@link Registration} for removing the event listener
     */
    @SuppressWarnings({ "rawtypes", "unchecked" })
    public Registration addAction3Listener(
            ComponentEventListener<Action3Event<R>> listener) {
